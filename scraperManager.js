...
export const ENABLE_CSV_UPLOAD = config.ENABLE_CSV_UPLOAD;

// Access configuration values from the imported config
const MAX_UPDATE_INTERVAL = config.MAX_UPDATE_INTERVAL;
const CONCURRENT_LIMIT = config.CONCURRENT_LIMIT;
const MAX_RETRIES = config.MAX_RETRIES;
const SCRAPE_TIMEOUT = config.SCRAPE_TIMEOUT;
const MIN_TIME_BETWEEN_EVENT_SCRAPES = config.MIN_TIME_BETWEEN_EVENT_SCRAPES;
const MAX_ALLOWED_UPDATE_INTERVAL = config.MAX_ALLOWED_UPDATE_INTERVAL;
const EVENT_FAILURE_THRESHOLD = config.EVENT_FAILURE_THRESHOLD;
...
// Recovery intervals
const CRITICAL_RECOVERY_INTERVAL = config.CRITICAL_RECOVERY_INTERVAL;
const AGGRESSIVE_RECOVERY_INTERVAL = config.AGGRESSIVE_RECOVERY_INTERVAL;
const STANDARD_RECOVERY_INTERVAL = config.STANDARD_RECOVERY_INTERVAL;
const AUTO_STOP_CHECK_INTERVAL = config.AUTO_STOP_CHECK_INTERVAL;

// Logging level
const LOG_LEVEL = config.LOG_LEVEL;

// Cookie and session settings
const COOKIE_EXPIRATION_MS = config.COOKIE_EXPIRATION_MS;
const SESSION_REFRESH_INTERVAL = config.SESSION_REFRESH_INTERVAL;

// Helper functions from config
const generateRandomIp = config.generateRandomIp;
const MIN_VALID_COOKIES = config.MIN_VALID_COOKIES;

// Fingerprint options
const FINGERPRINT_POOL = config.FINGERPRINT_POOL;
const randomFingerprint = config.randomFingerprint;

// Cookie management
const COOKIE_MANAGEMENT = config.COOKIE_MANAGEMENT;
...
const CSV_UPLOAD_INTERVAL = config.CSV_UPLOAD_INTERVAL;
