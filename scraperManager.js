                  ...
                  update: {
                    $set: {
                      ...
                      seats: group.seats.map((seatNumber) => ({
                        ...
                        price: parseFloat(increasedPrice.toFixed(2)),
                        mapping_id,
                      })),
                      inventory: {
                        ...
                        row: group.row,
                        cost: parseFloat(group.inventory.cost.toFixed(2)),
                        ...
                        listPrice: parseFloat(increasedPrice.toFixed(2)),
                        face_price: parseFloat(group.inventory.faceValue.toFixed(2)),
                        taxed_cost: parseFloat(group.inventory.taxedCost.toFixed(2)),
                        cost: parseFloat(group.inventory.cost.toFixed(2)),
                        ...
                        tickets: group.inventory.tickets.map((ticket) => ({
                          ...
                          notes: ticket.notes,
                          cost: parseFloat(ticket.cost.toFixed(2)),
                          faceValue: parseFloat(ticket.faceValue.toFixed(2)),
                          taxedCost: parseFloat(ticket.taxedCost.toFixed(2)),
                          sellPrice: parseFloat((typeof ticket?.sellPrice === "number" && !isNaN(ticket?.sellPrice) ? ticket.sellPrice : parseFloat(ticket?.cost || ticket?.faceValue || 0)).toFixed(2)),
